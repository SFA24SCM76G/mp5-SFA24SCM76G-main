...
class GameDetailsResponse {
  ...
  factory GameDetailsResponse.fromMap(Map<String, dynamic> map) {
  ...
  factory GameDetailsResponse.fromJson(String source) => GameDetailsResponse.fromMap(json.decode(source));
}